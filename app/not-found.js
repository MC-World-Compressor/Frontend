...
// Hook para detectar el locale desde la ruta (solo cliente)
function useDetectLocale() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      if (pathLocale === 'es' || pathLocale === 'en') {
        ...
        // fallback: intentar con navigator.language
        const navLang = navigator.language?.toLowerCase() || '';
        if (navLang.startsWith('en')) setLocale('en');
        else setLocale('es');
      }
    }
  }, []);
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-8 border border-blue-200 dark:border-blue-800 max-w-lg mx-auto shadow-lg backdrop-blur-sm">
      <div className="flex items-start">
        <div className="bg-blue-100 dark:bg-blue-800/50 p-3 rounded-full mr-4 flex-shrink-0">
        ...
        <div className="flex-1">
          <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-2">{t.contactInfo}</h4>
          <p className="text-sm text-gray-600 dark:text-gray-300 mb-6">{t.needHelp}</p>
          
          <div className="space-y-4">
            <div className="flex items-center group">
              <div className="bg-blue-100 dark:bg-blue-800/50 p-2 rounded-lg mr-3 group-hover:bg-blue-200 dark:group-hover:bg-blue-700/50 transition-colors">
                <svg className="h-4 w-4 text-blue-600 dark:text-blue-400" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"/>
                  <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"/>
                </svg>
              </div>
              <a href="mailto:srkktua@protonmail.com?subject=MCCompressor%20Help" className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 hover:underline transition-colors font-medium">
                srkktua@protonmail.com
              </a>
            </div>
            
            <div className="flex items-center group">
              <div className="bg-indigo-100 dark:bg-indigo-800/50 p-2 rounded-lg mr-3 group-hover:bg-indigo-200 dark:group-hover:bg-indigo-700/50 transition-colors">
                <svg className="h-4 w-4 text-indigo-600 dark:text-indigo-400" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://discord.com/users/529736520048050189" target="_blank" rel="noopener noreferrer" className="text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:underline transition-colors font-medium">
                Discord: @papela
              </a>
            </div>
            
            <div className="flex items-center group">
              <div className="bg-gray-100 dark:bg-gray-800/50 p-2 rounded-lg mr-3 group-hover:bg-gray-200 dark:group-hover:bg-gray-700/50 transition-colors">
              ...
              <a href="https://github.com/Papela" target="_blank" rel="noopener noreferrer" className="text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 hover:underline transition-colors font-medium">
                GitHub
              </a>
            </div>
          </div>
...
// Componente de navegación de ayuda
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <div className="flex-grow flex items-center justify-center px-4 py-16 bg-gray-50 dark:bg-gray-900">
          <div className="max-w-4xl mx-auto text-center space-y-12">
            {/* Error Code Display */}
            <h1 className="text-8xl md:text-9xl lg:text-[12rem] font-black text-transparent bg-clip-text bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-600 select-none leading-none">
              404
            </h1>
            {/* Main Content */}
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-lg max-w-2xl mx-auto">
                {locale === 'es' 
                  ? 'Aquí tienes algunos enlaces útiles que podrían ayudarte a encontrar lo que buscas'
                  : 'Here are some helpful links that might help you find what you\'re looking for'
                }
              </p>
            </div>
        ...
        <div className="py-16 px-4 bg-white dark:bg-gray-900">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h3 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-4">
                {locale === 'es' ? '¿Aún necesitas ayuda?' : 'Still Need Help?'}
              </h3>
              <p className="text-gray-600 dark:text-gray-300 text-lg max-w-2xl mx-auto">
                {locale === 'es' 
                  ? 'Si no puedes encontrar lo que buscas, no dudes en contactarnos directamente'
