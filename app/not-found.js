  ...
  <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-8 border border-blue-200 dark:border-blue-800 max-w-lg mx-auto shadow-lg backdrop-blur-sm">
    <div className="space-y-3">
      ...
      <div className="flex items-center">
        <svg
          className="h-4 w-4 mr-3 text-blue-600 dark:text-blue-400 flex-shrink-0"
          fill="currentColor"
          viewBox="0 0 20 20"
        >
        ...
        <a
          href="mailto:srkktua@protonmail.com?subject=MCWCompressor%Help"
          className="text-sm text-blue-700 dark:text-blue-300 hover:text-blue-900 dark:hover:text-blue-100 hover:underline transition-colors"
        >
      ...
      <div className="flex items-center">
        <svg
          className="h-4 w-4 mr-3 text-indigo-600 dark:text-indigo-400 flex-shrink-0"
          fill="currentColor"
          viewBox="0 0 24 24"
        >
        ...
        <a
          href="https://discord.com/users/529736520048050189"
          target="_blank"
          className="text-sm text-indigo-700 dark:text-indigo-300 hover:text-indigo-900 dark:hover:text-indigo-100 hover:underline transition-colors"
        >
          Discord: @papela
        </a>
      </div>
      <div className="flex items-center">
        <svg
          className="h-4 w-4 mr-3 text-gray-600 dark:text-gray-400 flex-shrink-0"
          fill="currentColor"
          viewBox="0 0 20 20"
        >
          <path
        ...
        <a
          href="https://github.com/MC-World-Compressor/Frontend"
          target="_blank"
          className="text-sm text-indigo-800 dark:text-indigo-300 hover:text-indigo-900 dark:hover:text-indigo-100 hover:underline transition-colors"
        >
          GitHub
        </a>
      </div>
