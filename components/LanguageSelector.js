    ...
    <>
      ...
      <div className="relative" ref={ref}>
        ...
        >
          {locale === "es" ? (
            <span
              className="inline-block w-5 h-5 mr-2 align-middle mt-2"
            ...
            >
              <svg
                ...
                height="16"
              >
                <rect width="60" height="40" fill="#CE1126" rx="4" />
        ...
        >
          <button
            ...
            disabled={locale === "es"}
            className={`block w-full text-left px-4 py-2 text-sm flex items-center gap-2 rounded-t-md ${
              locale === "es"
                ? "opacity-50 cursor-not-allowed bg-gray-300 dark:bg-gray-600 text-gray-900 dark:text-gray-200"
          ...
          <button
            ...
            disabled={locale === "en"}
            className={`block w-full text-left px-4 py-2 text-sm flex items-center gap-2 rounded-b-md ${
              locale === "en"
                ? "opacity-50 cursor-not-allowed bg-gray-300 dark:bg-gray-600 text-gray-900 dark:text-gray-200"
                : "text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"
            }`}
